...
if(isset($_POST['btn']))
    ...
    if(move_uploaded_file($filetempname,$filestore))
        {
            $sql="update staff set name='$name',image='$filename',designation='$designation' where id=$x";
            ...
            <div class="col-md-10 grid-margin stretch-card">
              <div class="card">
                ...
                <?php
                    $x=$_GET['z'];
                    $con=mysqli_connect("localhost","root","","project");
                    $sql1="select * from staff where id=$x";
                ...
                ?>
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="type" class="form-control" id="exampleInputdesignation1" name="designation" value="<?php echo $rw[3];?>">
                    </div>
