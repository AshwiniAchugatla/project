...
{
    $sql="update course set name='$name',image='$filename' where id=$x";
            ...
            <div class="col-md-10 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    ...
                    $x=$_GET['z'];
                    $con=mysqli_connect("localhost","root","","project");
                    $sql1="select * from course where id=$x";
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputname1" placeholder="Coursename" name="name" value="<?php echo $rw[1];?>">
                    </div>
                    <div class="form-group">
