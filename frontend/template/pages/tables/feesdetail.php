...
$totalfees=0;
$total = "select sum(fees) from studentdetails where sid = $id";
$totalres = mysqli_query($con,$total);
$row = mysqli_fetch_row($totalres);
$totalfees = $row[0];

$paidquery = "select sum(fees) from feestable where sid = $id";
$paidres = mysqli_query($con,$paidquery);
$paidrow = mysqli_fetch_row($paidres);

$paidfees = $paidrow[0];
$av = $totalfees - $paidfees;
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <?php
              $sql1="select name from register where id=$id";
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <?php
                        $sql="select * from feestable where sid=$id";
                        $res=mysqli_query($con,$sql);
                        $totalpaid=0;
                        $total=0;
                        while($rw=mysqli_fetch_row($res))
                        {
                          $total += $totalpaid + $rw[2];
                    ?>
                      <tbody>
                        <tr>
                          <td>
