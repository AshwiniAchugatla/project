...
if(move_uploaded_file($filetempname,$filestore))
{
  if(move_uploaded_file($pdftempname,$pdfstore))
    {
       $sql="update courseinfo set name='$name',Image='$filename',description='$description',file='$pdfname',duration='$duration',fees=$fees where cid=$x";
            ...
            <div class="col-md-10 grid-margin stretch-card">
              <div class="card">
                ...
                <?php
                    $x=$_GET['z'];
                    $con=mysqli_connect("localhost","root","","project");
                    $sql1="select * from courseinfo where cid=$x";
                ...
                ?>
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="your_summernote" name="description" value="<?php echo $rw[3];?>"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputfees1" name="fees" value="<?php echo $rw[6];?>">
                    </div>
