...
if(isset($_POST['btn']))
{
    ...
    $tb1="insert into notification(date,title,message)values('$date','$title','$message')";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleInputmessage1" placeholder="Type Your Message Here..." name="message"></textarea>
                    </div>
