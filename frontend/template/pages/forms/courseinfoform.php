...
if(move_uploaded_file($filetempname,$filestore))
{
  if(move_uploaded_file($pdftempname,$pdfstore))
    {
        $tb1="insert into courseinfo(name,Image,description,file,duration,fees)values('$name','$filename','$description','$pdfname','$duration',$fees)";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputname1" placeholder="Coursename" name="name">
                    </div>
                    <div class="form-group">
