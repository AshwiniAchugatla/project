...
$tb1="insert into admission(sid,batchid)values($sid,$batchid)";
    ...
    $tb2="update studentdetails set status='active' where sid=$sid";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    ...
                    <label for="exampleInputname1">Student Name</label>
                        <select id="exampleInputname1" name="name" class="form-control">
                    ...
                    <label for="exampleInputcourse1">Course Name</label>
                        <select class="form-control" name="course">
                            <option>Select Course</option>
                                <?php
                                    $sql1="select * from batch inner join coursedetail on batch.id=coursedetail.id";
                                    $res=mysqli_query($con,$sql1);
                                    while($rw=mysqli_fetch_array($res))
                                    {
                                    ?>
                                    <option value="<?php echo $rw[7];?>"><?php echo $rw[9];?></option>
                                    <?php
                                    }
                                    ?>
                        </select>
