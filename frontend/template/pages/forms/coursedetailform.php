...
if(move_uploaded_file($filetempname,$filestore))
{
  if(move_uploaded_file($pdftempname,$pdfstore))
    {
        $tb1="insert into coursedetail(cid,name,description,image,content,file,duration,fees)values('$vname','$name','$description','$filename','$content','$pdfname','$duration',$fees)";
                ...
                <div class="card-body">
                  ...
                  <label for="exampleInputvname1">Select CourseInfo Name</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputname1" placeholder="Course Name" name="name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputdescription1">Description</label>
                      <textarea class="form-control" id="your_summernote" placeholder="Decription of course detail" name="description"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="your_summernote1" placeholder="content of course detail" name="content"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputduration1" name="duration">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputfees1">Fees</label>
                      <input type="number" class="form-control" id="exampleInputfees1" name="fees">
                    </div>
