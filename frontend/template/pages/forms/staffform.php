...
if(isset($_POST['btn']))
    ...
    if(move_uploaded_file($filetempname,$filestore))
        {
            $tb1="insert into staff(name,image,designation)values('$name','$filename','$designation')";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputname1" placeholder="Staff Name" name="name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="type" class="form-control" id="exampleInputdesignation1" placeholder="role" name="designation">
                    </div>
