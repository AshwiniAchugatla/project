...
if(isset($_POST['btn']))
{
  ...
  {
$sql="update register set image='$filename',name='$name',mobileno=$mobileno,email='$email',password='$password',conformpassword='$conformpassword',coursename='$coursename' where email='$user'";
        ...
        <div class="container">
          <div class="row justify-content-center">
            ...
            <?php
                    ...
                    ?>
              <form class="bg-white rounded shadow-5-strong p-5" method="post" enctype="multipart/form-data">
                <!-- Email input -->
                ...
                <!-- Password input -->
                <div class="form-outline mb-4">
                  <input type="password" id="form1Example5" class="form-control" name="password" value="<?php echo $rw1[5];?>" required/>
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form1Example7" class="form-control" name="coursename" value="<?php echo $rw1[7];?>" required/>
                  <label class="form-label" for="form1Example7">Course Name</label>
                </div>
